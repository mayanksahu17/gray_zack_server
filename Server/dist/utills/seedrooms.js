...
exports.createHotelRooms = exports.createSampleRoom = exports.roomPayloads = void 0;
const mongoose_1 = require("mongoose");
// Sample hotel IDs - replace with actual IDs from your database
const hotelIds = [
    new mongoose_1.Types.ObjectId("60d21b4667d0d8992e610c85"), // Luxury hotel
    new mongoose_1.Types.ObjectId("60d21b4667d0d8992e610c85"), // Budget hotel
    new mongoose_1.Types.ObjectId("60d21b4667d0d8992e610c85") // Boutique hotel
];
...
const createSampleRoom = (index = 0) => {
    return exports.roomPayloads[index % exports.roomPayloads.length];
};
exports.createSampleRoom = createSampleRoom;
// Function to create multiple rooms for a specific hotel
const createHotelRooms = (hotelId, count = 5) => {
    const rooms = [];
    for (let i = 0; i < count; i++) {
        const baseRoom = (0, exports.createSampleRoom)(i);
        rooms.push(Object.assign(Object.assign({}, baseRoom), { hotelId, roomNumber: `${i + 101}` }));
    }
    return rooms;
};
exports.createHotelRooms = createHotelRooms;

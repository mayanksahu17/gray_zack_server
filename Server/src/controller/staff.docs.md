...
## Base URL: http://16.171.47.60:8000/api/v1/staff

### 1. Create Staff Member (POST /create)
Required Role: HOTEL_OWNER or ADMIN
```bash
curl -X POST http://16.171.47.60:8000/api/v1/staff/create \
...
```bash
curl -X POST http://16.171.47.60:8000/api/v1/staff/login \
-H "Content-Type: application/json" \
-d '{
  "email": "john.doe@hotel.com",
  "password": "StaffPass123!"
...
Required Role: HOTEL_OWNER or ADMIN
```bash
curl -X GET "http://16.171.47.60:8000/api/v1/staff/hotel/65f123456789abcdef123456?page=1&limit=10&role=front_desk&status=active" \
-H "Authorization: Bearer YOUR_ACCESS_TOKEN"
...
Required Role: HOTEL_OWNER or ADMIN
```bash
curl -X PUT http://16.171.47.60:8000/api/v1/staff/65f123456789abcdef123457 \
-H "Content-Type: application/json" \
-H "Authorization: Bearer YOUR_ACCESS_TOKEN" \
-d '{
...
Required Role: HOTEL_OWNER or ADMIN
```bash
curl -X DELETE http://16.171.47.60:8000/api/v1/staff/65f123456789abcdef123457 \
-H "Authorization: Bearer YOUR_ACCESS_TOKEN"
...
```bash
curl -X POST http://16.171.47.60:8000/api/v1/staff/refresh-token \
-H "Content-Type: application/json" \
-d '{
...
```bash
curl -X POST http://16.171.47.60:8000/api/v1/staff/logout \
-H "Authorization: Bearer YOUR_ACCESS_TOKEN"

        ...
        <div className="flex items-center space-x-6">
          ...
          <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
            <DropdownMenuTrigger className="flex items-center space-x-3 focus:outline-none p-2 hover:bg-blue-50 rounded-lg transition-colors">
              ...
              <div className="hidden md:block text-lg font-medium">Jane Doe</div>
            ...
            <DropdownMenuContent align="end" className="w-72 animate-in fade-in-80 zoom-in-95 p-1">
              <div className="px-6 py-4 border-b border-gray-100">
                ...
                <p className="text-base text-gray-500">jane.doe@hotelexample.com</p>
              </div>
              ...
              <DropdownMenuItem className="cursor-pointer text-base py-3 px-6 text-red-600 hover:text-red-700 hover:bg-red-50">
